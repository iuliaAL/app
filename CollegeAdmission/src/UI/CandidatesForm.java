...
public class CandidatesForm extends JFrame{
    ...
    private String[] allCandidatesTableColumnValues = {"CNP", "Name", "Bac average", "High School Average", "Options"};
    private String[] admittedCandidatesTableColumnValues = {"CNP", "Name", "Final Grade", "Section"};
    private String[] failedCandidatesTableColumnValues = {"CNP", "Name", "Final Grade"};
