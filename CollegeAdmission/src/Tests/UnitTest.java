...
public class UnitTest {
    ...
    private void runTests() throws MyException {
        ...
        assert controller.getAllSections().size()==0 : "Error loading sections";
        ...
        assert controller.getAllSections().size()==2 : "Error adding sections";
        ...
        assert controller.getAllCandidates().size()==0: "Error loading candidates";
        ...
        assert repository.getFailedCandidates().size()==1: "Error loading candidates";
        assert repository.getAdmittedCandidates().size()==2:"Error generating results";
        ...
        assert controller.getAllCandidates().size()==0: "Error removing candidates";
        /*if (controller.getAllCandidates().size() != 0){
        ...
        assert controller.getAllSections().size()==0: "Error removing sections";
        /*if (controller.getAllSections().size() != 0){
